...
if (isset($SEARCH)) {
    $ft .= " AND (tc_fname_th LIKE '%" . $SEARCH . "%' OR tc_lname_th LIKE '%" . $SEARCH . "%' OR tc_fname_en LIKE '%" . $SEARCH . "%' OR tc_lname_en LIKE '%" . $SEARCH . "%')";
}
...
<head>
    ...
    <link rel="icon" href="../../assetc/img/kaiadmin/favicon.ico" type="image/x-icon" />
                    ...
                    <div class="row">
                                ...
                                <form action="" method="get" id="search-form">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <p class="op-7">ค้นหาด้วย : ชื่อ-นามสกุลอาจารย์</p>
                                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                $SQL_teacher = "SELECT *
                                                FROM teacher
                                                WHERE delete_flag = '0' " . $ft. " ORDER BY tp_id ASC " . $offset;
                                $result_teacher = data_FetchAll($SQL_teacher);

                                $sql_row = "SELECT COUNT(*)
                                                FROM teacher
                                                WHERE delete_flag = '0' " . $ft;
                                ...
                                ?>
                                    <div class="col-md-12">
                                        <a class="hover-zoom" href="teacher_view.php?tc_id=<?= base64_encode($value_tc['tc_id']) ?>">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <h4><b><?= get_teacher_name($value_tc['tc_id'], "TH"); ?></b></h4>
                                                                <h6><?= get_teacher_name($value_tc['tc_id'], "EN"); ?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10 d-none d-md-flex">
                                                                <h6>
                                                                    <span class="badge badge-success"><?= get_teacher_position_name($value_tc['tp_id']) ?></span>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </div>
