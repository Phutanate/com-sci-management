...
$_SESSION["PAGE_TITLE"] = "จัดการข้อมูลตำแหน่งอาจารย์";
...
if (isset($_GET['tp_id'])) {
    $tp_id = base64_decode($_GET['tp_id']);
    $SQL_teacher_position = "SELECT * FROM teacher_position WHERE tp_id = '" . $tp_id . "'";
    $data_main = data_Fetch($SQL_teacher_position);
} else {
    $data_main['tp_id'] = "";
    $data_main['tp_name_th'] = "";
    $data_main['tp_name_en'] = "";
}
                ...
                <div class="page-inner">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumbs mb-3">
                            ...
                            <li class="nav-home">
                                <a href="data_basic_teacher_position_table.php">
                        ...
                        <div class="col-md-12">
                            <div class="card card-secondary">
                                <div class="card-body bubble-shadow">
                                    <form onsubmit="teacher_position_process(event,'edit','<?= base64_encode($data_main['tp_id']) ?>');">
                                        <div class="row">
                                            <div class="col-md-12 ">
                                            </div>
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 ">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input id="TP_NAME_TH" name="TP_NAME_TH" type="text" class="form-control ps-3" placeholder="ชื่อตำแหน่ง TH" value="<?= $data_main['tp_name_th'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 ">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input id="TP_NAME_EN" name="TP_NAME_EN" type="text" class="form-control ps-3" placeholder="ชื่อตำแหน่ง EN" value="<?= $data_main['tp_name_en'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 ">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <a class="btn btn-warning m-3" href="data_basic_teacher_position_table.php">กลับ</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<script src="../asset/js/script_data_basic_teacher_position.js"></script>