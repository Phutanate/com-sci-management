...
if (isset($_GET['ts_gt_id'])) {
    $ts_gt_id = base64_decode($_GET['ts_gt_id']);
    $SQL_thesis_grouptype = "SELECT * FROM thesis_grouptype WHERE ts_gt_id = '" . $ts_gt_id . "'";
    $data_main = data_Fetch($SQL_thesis_grouptype);
} else {
    $data_main['ts_gt_id'] = "";
    $data_main['ts_gt_name'] = "";
    $data_main['ts_gt_number'] = "";
}
                        ...
                        <div class="col-md-12">
                            <div class="card card-secondary">
                                <div class="card-body bubble-shadow">
                                    <form onsubmit="thesis_grouptype_process(event,'edit','<?= base64_encode($data_main['ts_gt_id']) ?>');">
                                        <div class="row">
                                            <div class="col-md-12 ">
                                            </div>
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 ">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input id="TS_GT_NAME" name="TS_GT_NAME" type="text" class="form-control ps-3" placeholder="ชื่อประเภทกลุ่มโครงงาน" value="<?= $data_main['ts_gt_name'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 ">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <input id="TS_GT_NUMBER" name="TS_GT_NUMBER" type="number" class="form-control ps-3" placeholder="จำนวนนักศึกษาต่อกลุ่ม" value="<?= $data_main['ts_gt_number'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
