...
$_SESSION["PAGE_TITLE"] = "ข้อมูลตำแหน่งอาจารย์";
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a class="btn btn-primary btn-round ms-auto" href="data_basic_teacher_position_add.php">
                                    ...
                                    <div class="table-responsive">
                                        <table id="multi-filter-select" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($result_teacher_position as $key_tc_tp => $value_tc_tp) {
                                                ?>
                                                    <tr>
                                                        <td><?= $value_tc_tp['tp_name_th'] ?></td>
                                                        <td><?= $value_tc_tp['tp_name_en'] ?></td>
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a class="btn btn-sm btn-primary mx-1" href="data_basic_teacher_position_manage.php?tp_id=<?= base64_encode($value_tc_tp['tp_id']) ?>" data-bs-toggle="tooltip" data-original-title="จัดการ" title="จัดการ">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a class="btn btn-sm btn-danger mx-1" href="javascript:void(0);" onclick="delete_data('<?= base64_encode($value_tc_tp['tp_id']) ?>')" data-bs-toggle="tooltip" data-original-title="ลบ" title="ลบ">
