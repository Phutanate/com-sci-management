                        ...
                        <div class="col-md-12">
                            <div class="card card-secondary">
                                <div class="card-body bubble-shadow">
                                    <form onsubmit="teacher_process(event,'edit','<?= base64_encode($data_main['tc_id']) ?>');">
                                        <div class="row">
                                            <div class="col-md-12 ">
                                            </div>
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 ">
                                                        <div class="form-group form-group-default">
                                                            <label>ชื่อ TH</label>
                                                            <input id="TC_FNAME_TH" name="TC_FNAME_TH" type="text" class="form-control ps-3" placeholder="ชื่อ TH" value="<?= $data_main['tc_fname_th'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 ">
                                                        <div class="form-group form-group-default">
                                                            <label>นามสกุล TH</label>
                                                            <input id="TC_LNAME_TH" name="TC_LNAME_TH" type="text" class="form-control ps-3" placeholder="นามสกุล TH" value="<?= $data_main['tc_lname_th'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 ">
                                                        <div class="form-group form-group-default">
                                                            <label>ชื่อ EN</label>
                                                            <input id="TC_FNAME_EN" name="TC_FNAME_EN" type="text" class="form-control ps-3" placeholder="ชื่อ EN" value="<?= $data_main['tc_fname_en'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 ">
                                                        <div class="form-group form-group-default">
                                                            <label>นามสกุล EN</label>
                                                            <input id="TC_LNAME_EN" name="TC_LNAME_EN" type="text" class="form-control ps-3" placeholder="นามสกุล EN" value="<?= $data_main['tc_lname_en'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 ">
                                                        <div class="form-group form-group-default">
                                                            ...
                                                            <select class="form-select form-control ps-3" id="TP_ID" name="TP_ID" onchange="change_academic_year()">
                                                                ...
                                                                ?>
                                                                    <option value="<?= $value_tp['tp_id'] ?>" <?= ($data_main['tp_id'] == $value_tp['tp_id']) ? 'selected' : '' ?>><?= $value_tp['tp_name_th'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
